...
struct UpdateCommand: AsyncParsableCommand {
    ...
    static let releasesAPIURL = URL(string: "https://api.github.com/repos/rcodexpdf/rCodexPDF/releases/latest")!
    static let installScriptURL = "https://raw.githubusercontent.com/rcodexpdf/rCodexPDF/main/install.sh"
